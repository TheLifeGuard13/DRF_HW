...
class MaterialTestCase(APITestCase):
    def setUp(self) -> None:
        ...
        self.lesson = Lesson.objects.create(name="test_lesson_1", owner=self.user)
        self.course = Course.objects.create(name="test_course_1", owner=self.user)

    def test_create_lesson(self):
        """Тестирование создания урока"""
        url = reverse("materials:create_lesson")
        data = {"name": "test_lesson_2", "owner": self.user.pk}
    ...
    def test_create_lesson_error(self):
        ...
        url = reverse("materials:create_lesson")
        data = {"name": "test_lesson_3", "owner": self.user.pk, "url": "123@mail.ru"}
        response = self.client.post(url, data=data)
    ...
    def test_change_subscription(self):
        ...
        new_subscription = {"course": self.course.pk, "subscriber": 1}
    ...
    def test_create_course(self):
        ...
        data = {"name": "test_course", "description": "test_course_description", "owner": self.user.pk}
